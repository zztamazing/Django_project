...
def createSkill(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            skill.owner = profile
            skill.save()
            messages.success(request, 'Skill was added successfully :D')
            return redirect('user-account')
...
def updateSkill(request, pk):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            form.save()
            messages.success(request, 'Skill was edited successfully :D')
            return redirect('user-account')
...
def deleteSkill(request, pk):
    ...
    if request.method == "POST":
        skill.delete()
        messages.success(request, 'Skill was deleted successfully :D')
        return redirect('user-account')
