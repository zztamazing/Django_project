 ...
 * the result types you actually want (string instead of `exec`-styles array in match-first mode,
 ...
 * characters A-Z, a-z, 0-9, _, and $ only. Names can't be integers. Supports Python-styles
 * `(?P<name>` as an alternate syntax to avoid issues in some older versions of Opera which natively
 * supported the Python-styles syntax. Otherwise, XRegExp might treat numbered backreferences to
 * Python-styles named capture as octals.
 */
XRegExp.addToken(
    /\(\?P?<([\w$]+)>/,
    function(match) {
